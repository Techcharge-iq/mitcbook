          ...
          <TooltipProvider>
            ...
            <HashRouter>
              <Routes>
                ...
                {/* Company setup - requires auth but shown before dashboard */}
                <Route path="/setup" element={<ProtectedRoutes><Suspense fallback={<LoadingScreen />}><CompanySetup /></Suspense></ProtectedRoutes>} />
